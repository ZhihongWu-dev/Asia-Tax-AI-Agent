...
时间以 1 名产品负责人、1 名香港税务专家、2 名工程师及兼职设计/安全支持为基准，实际速度取决于专家参与和资料质量。
...
退出条件：达到 PRD 成功指标，且不存在未控制的高风险错误类别。

MVP 预计合计 10–16 周，不包含客户采购、外部安全认证或大规模历史资料清理时间。
