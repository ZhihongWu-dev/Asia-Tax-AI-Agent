...
were taxed overseas is not yet known.`,
  ...
  "foreign_tax_on_dividend_...": "unknown"
}`,
  },
  {
    number: "III",
    title: "Run the chain, cite the law",
    description:
      "The implemented FSIE steps run as deterministic code. The run ends in a safe terminal state, lists what a human must decide, and quotes the statute.",
    file: "chain.log",
    code: `1 scope                 established
2 income                established
3 receipt   s.15I       established
5 substance s.15K       unknown
6 participation s.15M(2) human review
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Three steps.
            <br />
            <span className="text-background/50">Each one inspectable.</span>
          </h2>
        </div>
          ...
          <div className="lg:sticky lg:top-32 self-start">
            <div className="border border-background/10 overflow-hidden">
              ...
              <div className="px-6 py-4 border-t border-background/10 flex items-center gap-3">
                ...
                <span className="text-xs font-mono text-background/40">Illustrative excerpt</span>
              </div>
            </div>
          </div>
        </div>
