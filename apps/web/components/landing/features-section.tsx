...
const features = [
  {
    ...
    description:
      "The language model only fills candidate facts from a 43-field dictionary. Anything outside that vocabulary is rejected after one repair round, and nothing the model writes can be marked as confirmed.",
    visual: "ai",
  },
  {
    number: "02",
  ...
  {
    number: "03",
    title: "Unknown is never no",
    description:
      "Missing facts stay unknown, contradictory facts stop the run, and questions reserved for professional judgement are escalated to a person instead of guessed.",
    visual: "collab",
  },
  {
    number: "04",
    title: "No conclusion without a human",
    description:
      "There is no exempt or taxable output. Every run ends in one of three safe states, and every report carries a research watermark that cannot be switched off.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Built to be checked.
            <br />
            <span className="text-muted-foreground">Not trusted blindly.</span>
          </h2>
        </div>
